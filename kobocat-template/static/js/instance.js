...
function createTable(canEdit,datavals) {
    ...
    if (canEdit === true) {
        var editDelete = '<div class="row"><div class="col-md-6"><a id="title_edit" href="#kate" class="btn red disabled">' + gettext("edit") + '</a>&nbsp;<a href="#"class="btn red">' + gettext("Delete") + '</a></div></div><div class="top-buffer-min">';
            ...
            var childQuestions = {};
                ...
                for(cdx in datavals){
                    if(cdx.indexOf(key+'_') != -1){
                        ...
                        if(typeof childQuestions[repeatLabel] != 'undefined'){
                            responseData += '<tr><td>'+childQuestions[repeatLabel].getLabel()+'</td><td>'+datavals[cdx]+'</td></tr>';
                        } else {
