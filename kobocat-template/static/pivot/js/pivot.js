  ...
  callWithJQuery(function($) {
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      ...
      try {
        ...
        uiTable = $("<table>", {
          "class": "pvtUi table table-bordered"
        });
        rendererControl = $("<td>");
        renderer = $("<select>").addClass('pvtRenderer btn red').appendTo(rendererControl).bind("change", function() {
          return refresh();
        });
        ref1 = opts.renderers;
        for (x in ref1) {
        ...
        fn = function(c) {
          ...
          attrElem = $("<li>").addClass("axis_" + i).append($("<span>").addClass('pvtAttr btn').text(c).data("attrName", c).append(triangleLink));
          if (hasExcludedItem) {
            attrElem.addClass('pvtFilteredAttribute');
          }
        ...
        aggregator = $("<select>").addClass('pvtAggregator btn red').bind("change", function() {
          return refresh();
        });
          ...
          return function() {
            ...
            if (numInputsToProcess !== 0) {
              ...
              for (x = s = 0, ref6 = numInputsToProcess; 0 <= ref6 ? s < ref6 : s > ref6; x = 0 <= ref6 ? ++s : --s) {
                newDropdown = $("<select>").addClass('pvtAttrDropdown btn red').append($("<option>")).bind("change", function() {
                  return refresh();
                });
