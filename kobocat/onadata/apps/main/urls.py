...
urlpatterns = patterns(
    ...
    # main website views
    url(r'^csvp/form_summary/$', 'onadata.apps.main.views.survey_summary'),
    #url(r'^snl-dashboard/$', 'onadata.apps.main.views.snlDashboard', name='snlDashboard'),
    url(r'^csvp/village/(?P<village_id>[^/]+)/$', 'onadata.apps.main.views.csvp_single_village'),
    url(r'^csvp/villages/$', 'onadata.apps.main.views.villages_list'),
    url(r'^$', 'onadata.apps.main.views.csvp_dashboard'),
    #url(r'^$', 'onadata.apps.main.views.d2dashboard', name='d2'),
    url(r'^mapfilter/$', 'onadata.apps.main.views.searchByRegionCat'),
    ...
    #url(r"^(?P<username>\w+)/forms/(?P<id_string>[^/]+)/get-logger-instance",
    #    'onadata.apps.viewer.views.get_logger_instance'),
